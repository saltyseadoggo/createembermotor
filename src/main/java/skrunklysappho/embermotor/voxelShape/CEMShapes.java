package skrunklysappho.embermotor.voxelShape;
...
import java.util.function.BiFunction;
    ...
    // This class' code makes generating VoxelShapes for blocks based on which way they're facing much easier.
    // - Code originally from Create's `AllShapes` class

public class CEMShapes {
